...
# %% auto #0
__all__ = ['CHARS_PER_TOKEN', 'mk_content', 'is_media', 'mk_msg', 'mk_msgs', 'strip_media', 'to_media_part', 'mk_toolspec',
           'ToolCall', 'tc_name', 'mk_tool_res_msg', 'mk_tool_res_msgs', 'parse_args', 'norm_resp', 'to_oai_msg',
           'sum_usage', 'est_tokens', 'render_prompt', 'common_prefix_len']

# %% ../nbs/02_msgs.ipynb #d40e9902
import json, math, os
