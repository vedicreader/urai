...
# %% auto #0
__all__ = ['MODALITIES', 'ENDPOINT_TOOLS', 'CAPS_FALLBACK', 'MODEL_EXTS', 'Caps', 'tool_modalities', 'tbl_caps', 'fallback_caps',
           'hosted_caps', 'is_path', 'hub_files', 'mmproj_caps', 'read_cfg', 'cfg_caps']

# %% ../nbs/03_caps.ipynb #457c6663
import json
from dataclasses import dataclass
from fastcore.all import Path, first

# %% ../nbs/03_caps.ipynb #1833ab76
